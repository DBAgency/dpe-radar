...
// Validate ../../src/app/api/dpe/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/dpe">> = Specific
  const handler = {} as typeof import("../../src/app/api/dpe/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
